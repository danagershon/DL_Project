import argparse
import training_variational_auto_decoder
import evaluation_utils
import saving_utilities
from hyperparameters import variational_auto_decoder_hyperparameters
...
def main(train_flag, results_dir=None):
    ...
    if train_flag:
        ...
        saving_utilities.save_hyperparameters(variational_auto_decoder_hyperparameters, results_dir)
        # Train the model and save pth files in the output_dir
        training_variational_auto_decoder.train_variational_auto_decoder(output_dir=results_dir, **variational_auto_decoder_hyperparameters)
